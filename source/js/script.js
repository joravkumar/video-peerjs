...
document.addEventListener(
    ...
    function (event) {
      ...
      var peer = new Peer(qid, {
        host: "regal-fuchsia-egg.glitch.me",
        port: 443,
        path: "/peerjs",
        debug: 3,
        config: {
      ...
      peer.on("connection", function (connection) {
        ...
        document.getElementById("btnClose").onclick = function () {
          ...
          peer.destroy();
          if (closeNow) {
            if (qid == "instructor") window.location.href = "/instructor";
            else if (qid == "student") window.location.href = "/student";
          }
        };
        if (qid == "instructor") {
          document.getElementById("connect-to-peer-btn").click();
        ...
        if (qid == "instructor") rFileName = "instructor.webm";
        else if (qid == "student") rFileName = "student.webm";
      ...
      function handleMessage(data) {
        ...
        if (data.from == "instructor") textClass = "danger";
      ...
      requestLocalVideo({
        success: function (stream) {
          ...
          mycamera.captureStream =
            mycamera.captureStream || mycamera.mozCaptureStream;
          if (qid == "student") {
            document.getElementById("call").click();
          }
